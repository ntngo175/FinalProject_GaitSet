...
class DataSet(tordata.Dataset):
    def __init__(self, seq_dir, label, seq_type, view, cache, resolution):
        # print('1 seq_dir: {}'.format(seq_dir))
        # label_len = len(label)
        # print('1 label len: {}'.format(label_len))
        # seq_type_len = len(seq_type)
        # print('1 seq_type len: {}'.format(seq_type_len))
        # print('1 resolution: {}'.format(resolution))
    ...
    def __getitem__(self, index):
        ...
        # print('frame_set: {}'.format(frame_set))
        # print('self-view: {}'.format(self.view[index]))
        # print('self-label: {}'.format(self.label[index]))
