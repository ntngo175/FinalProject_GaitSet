...
if __name__ == '__main__':
    ...
    silhouette_folder = "/content/drive/MyDrive/FinalGaitSet/dataset/test_probe"
    silhouette_cut_folder = "/content/drive/MyDrive/FinalGaitSet/dataset/after_test_probe"  # or None
